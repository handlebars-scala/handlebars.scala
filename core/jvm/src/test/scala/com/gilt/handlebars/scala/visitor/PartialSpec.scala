...
class PartialSpec extends FunSpec with Matchers {
  ...
  describe("file partials") {
    it("Complext partials") {
      val filetest = new File("jvm/src/test/resources/filetest.handlebars")
    ...
    it("fail to find partial while creating a template") {
      val filetest = new File("jvm/src/test/resources/missingPartial.handlebars")
    ...
    it("does not infinite parse partials") {
      ...
      val hbs = Handlebars(new File("jvm/src/test/resources/recursiveMain.handlebars"))
    ...
    it("not infinite loop with circular dependencies") {
      ...
      val hbs = Handlebars(new File("jvm/src/test/resources/person.handlebars"))
